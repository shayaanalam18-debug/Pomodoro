...
function initPomodoro() {
  ...
  function playTone(freq, durationMs, type = "sine", volume = 0.06) {
  ...
  function playSoundPreset(soundKey) {
    ...
    switch (soundKey) {
      case "chime":
        playTone(523.25, 140, "sine", 0.05); // C5
        setTimeout(() => playTone(659.25, 180, "sine", 0.05), 120); // E5
        break;
      case "beep":
        playTone(880, 180, "square", 0.045);
        break;
      case "soft":
        playTone(330, 260, "sine", 0.035);
        break;
      default:
        break;
    }
